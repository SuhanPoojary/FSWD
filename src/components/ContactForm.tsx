    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <Label htmlFor="companyName" className="text-sm block mb-2">
              Company Name
            </Label>
            <Input
              type="text"
          ...
          <div>
            <Label htmlFor="contactName" className="text-sm block mb-2">
              Contact Person
            </Label>
            <Input
              type="text"
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <textarea
              ...
              required
              rows={4}
              className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#FF4B55]"
            />
          </div>
