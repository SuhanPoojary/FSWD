...
const sheetVariants = (side) => {
  ...
  return `${baseClasses} ${sideClasses[side || "right"]}`;
};
...
const SheetTitle = React.forwardRef((props, ref) => {
  ...
  return (
    <SheetPrimitive.Title ref={ref} className={cn("text-lg font-semibold text-foreground", className)} {...rest} />
  );
});
...
const SheetDescription = React.forwardRef((props, ref) => {
  ...
  return (
    <SheetPrimitive.Description ref={ref} className={cn("text-sm text-muted-foreground", className)} {...rest} />
  );
});
