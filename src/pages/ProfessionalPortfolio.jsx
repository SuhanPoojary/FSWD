    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow bg-[#EDEEF1] py-12 px-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow p-8">
          <h1 className="text-2xl font-bold text-[#004A57] mb-6">Create Your Professional Profile</h1>
          <p className="text-gray-600 mb-8">Complete your professional profile to showcase your expertise and connect with clients.</p>
